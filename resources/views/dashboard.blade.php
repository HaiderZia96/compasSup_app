...
@section('title','Compus Sup | Admin Dashboard')
                        ...
                        <div class="card card-animate">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 overflow-hidden ms-3">
                                        <p class="text-uppercase fw-medium text-muted text-truncate mb-3">Total Service Providers</p>
                                        <div class="d-flex align-items-center mb-3">
                                            <h4 class="fs-4 flex-grow-1 mb-0"><span class="counter-value" data-target="168">0</span>m</h4>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive table-card">
                            <table class="table table-borderless table-nowrap align-middle mb-0">
                                ...
                                <tr>
                                    <td class="d-flex">
                                        <img src="{{asset('assets/images/users/avatar-1.jpg')}}" alt="" class="avatar-xs rounded-3 me-2 material-shadow">
                                        <div>
                                ...
                                <tr>
                                    <td class="d-flex">
                                        <img src="{{asset('assets/images/users/avatar-2.jpg')}}" alt="" class="avatar-xs rounded-3 me-2 material-shadow">
                                        <div>
